...
R package **remind**, version **36.172.7**
...
Giannousakis A and Pehl M (2020). _remind: The REMIND R package_. R package version 36.172.7.
...
@Manual{,
  ...
  year = {2020},
  note = {R package version 36.172.7},
}
```
